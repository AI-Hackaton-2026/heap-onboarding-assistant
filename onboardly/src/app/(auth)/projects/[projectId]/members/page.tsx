...
// repo's GitHub collaborators. Access is via getProjectAccess: org owners and
// ACTIVE members can view; only admins manage. 404s when the caller has no access.
